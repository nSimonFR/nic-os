...
`rpi5/picoclaw/` deleted. The shared cross-agent skills, the agent-local skills,
...
| Was | Is now |
|---|---|
| `rpi5/picoclaw/picoclaw.nix` | `rpi5/hermes/hermes.nix` |
| `rpi5/picoclaw/skills/` | `shared/skills/` + `rpi5/hermes/skills/` |
...
| routing in `rpi5/litellm.nix` | inline in `rpi5/hermes/hermes.nix` |
...
Residue cleaned up on 2026-08-06: `rpi5/hermes/documents/TOOLS.md` was a **live**
...
The lesson worth keeping: **the persona documents under `rpi5/hermes/documents/`
