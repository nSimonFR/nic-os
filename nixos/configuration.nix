...
in
{
  ...
  # Manage alfie's Hyprland config declaratively (replaces upstream autogenerated example).
  systemd.tmpfiles.rules = [
    "L+ /home/alfie/.config/hypr/hyprland.conf - - - - ${./dotfiles/hypr/hyprland-alfie.conf}"
  ];
