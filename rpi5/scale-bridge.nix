...
in
{
  ...
  # node-ble connects to the QN scale but its GATT service resolution
  # ("acquisition") stalls without BlueZ experimental features (AcquireNotify /
  # ServicesResolved). Enable them so the read completes after connect.
