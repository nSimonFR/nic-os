...
in
{
  ...
  # Cap V8 heap — Next.js defaults are generous; 64 MB is plenty for a dashboard
  systemd.services.homepage-dashboard.environment.NODE_OPTIONS = "--max-old-space-size=64";
