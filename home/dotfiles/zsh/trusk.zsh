...
# Local port for the bastion tunnels, matching the remote proxy's own 8888.
# The Claude Aperture shim used to squat this port; it now lives on 18888
# (home/claude-aperture-shim.nix) precisely so this one stays free.
export TRUSK_PROXY_PORT=8888
...
alias proxy-tools-down="unset http_proxy https_proxy HTTP_PROXY HTTPS_PROXY && ssh -S /tmp/bastion-lzrn.socket -O exit bastion-lzrn -q"
