...
- Autoprofile switcher: `hosts/beast/piper-autoprofile.nix` (switches profiles based on Hyprland window class)

## Environment
- NixOS with Hyprland
- Hyprland kb_options: `ctrl:nocaps`
- See `hosts/beast/dotfiles/hypr/hyprland.conf` for keybindings and window rules
