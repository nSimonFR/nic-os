# hosts/rpi5/ryot-connectors.nix
#
...
# that accepts a `CompleteExport` body — see hosts/rpi5/ryot.nix for the proxy route).
#
...
# exactly like the documented TMDB case. Secrets declared in hosts/rpi5/secrets.nix:
